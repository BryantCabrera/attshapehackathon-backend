# attshapehackathon-backend

## A. Description
attshapehackathon is a React app that connects to this Node.js/Express backend.  The project was built in 1.5 days by: 
...
## F. Github workflow
1.	Link to repo: [https://github.com/BryantCabrera/attshapehackathon-backend](https://github.com/BryantCabrera/attshapehackathon-backend).  
2.	Log into your personal repo.  Then, click link above and fork the repo.  Make sure the repo is in your personal GitHub (go to your personal GitHub account and the project repo “mom-me” should be there).  Then, from YOUR PERSONAL FORK, clone it to your local repo.
    ...
    2.  $git remote add upstream https://github.com/BryantCabrera/attshapehackathon-backend
